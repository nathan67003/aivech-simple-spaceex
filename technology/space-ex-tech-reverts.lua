...
if not settings.startup["aivech-ssx-equipment-research"].value then
  ...
  local worker_robots_speed3 = data.raw.technology["worker-robot-speed-3"]
  ...
  local worker_robots_speed4 = data.raw.technology["worker-robot-speed-4"]
  ...
  local worker_robots_speed5 = data.raw.technology["worker-robot-speed-5"]
